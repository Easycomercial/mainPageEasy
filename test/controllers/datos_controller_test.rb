...
class DatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dato" do
    assert_difference('Dato.count') do
      post datos_url, params: { dato: { description: @dato.description, email: @dato.email, name: @dato.name, phone: @dato.phone } }
    end
  ...
  test "should update dato" do
    patch dato_url(@dato), params: { dato: { description: @dato.description, email: @dato.email, name: @dato.name, phone: @dato.phone } }
